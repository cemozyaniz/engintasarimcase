...
class Users extends CI_Controller
{
    ...
    public function save()
    {
        ...
        $this->form_validation->set_rules("re_password", "Şifre", "required|trim|min_length[6]|matches[password]");
    ...
    public function update($id)
    {
        ...
        }elseif ($oldUser->email != $this->input->post("email")){
            $this->form_validation->set_rules("email", "E-posta Adresi", "required|trim|valid_email|is_unique[users.email]");
        ...
        if ($validate) {
            ...
            $update = $this->user_model->update(array("id" => $id), array(
                "user_name" => $this->input->post("user_name"),
                "full_name" => $this->input->post("full_name"),
                "email" => $this->input->post("email"),
            ));
