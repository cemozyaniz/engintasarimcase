!function (t, e) {
    ...
    function ft(t) {
        wn.isVisible() && gt !== t.target.value && wn.resetValidationMessage(), gt = t.target.value
    }
    ...
    function ht(t, e) {
        ...
        e.showConfirmButton || e.showDenyButton || e.showCancelButton || at(n), z(n, e, "actions"), Pt(i, "confirm", e), Pt(r, "deny", e), Pt(a, "cancel", e), o.innerHTML = e.loaderHtml, e.buttonsStyling ? function (t, e, n, o) {
    ...
    function Ot(t, e, n) {
        var o, i;
        n.inputLabel && (t.id = J.input, o = document.createElement("label"), i = J["input-label"], o.setAttribute("for", t.id), o.className = i, o.innerText = n.inputLabel, e.insertAdjacentElement("beforebegin", o))
    }
    ...
    var Tt = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap},
        Lt = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Dt = function (t) {
            if (!Mt[t.input]) return Y('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"'));
    ...
    Mt.text = Mt.email = Mt.password = Mt.number = Mt.tel = Mt.url = function (t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : b(e.inputValue) || K('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), Ot(t, t, e), St(t, e), t.type = e.input, t
        ...
        var n, o;
        return e.value = t.inputValue, St(e, t), Ot(e, e, t), "MutationObserver" in window && (n = parseInt(window.getComputedStyle(x()).width), o = parseInt(window.getComputedStyle(x()).paddingLeft) + parseInt(window.getComputedStyle(x()).paddingRight), new MutationObserver(function () {
    ...
    function Vt(t, e) {
        var n, o, i, r, a, s = P().querySelector("#".concat(J.content));
        e.html ? (mt(e.html, s), rt(s, "block")) : e.text ? (s.textContent = e.text, rt(s, "block")) : at(s), n = t, o = e, i = P(), r = Tt.innerParams.get(n), a = !r || o.input !== r.input, Lt.forEach(function (t) {
            var e = J[t], n = bt(i, e);
            qt(t, o.inputAttributes), n.className = e, a && at(n)
        }), o.input && (a && Dt(o), jt(o)), z(P(), e, "content")
    }
    ...
    function Ht(t, c) {
        ...
        rt(u), u.textContent = "";
        var l = parseInt(void 0 === c.currentProgressStep ? Rt() : c.currentProgressStep);
    ...
    function Nt(t, e) {
        ...
        z(l, e, "header"), Ht(0, e), n = t, o = e, (r = Tt.innerParams.get(n)) && o.icon === r.icon && B() ? zt(B(), o) : (Ft(), o.icon && (-1 !== Object.keys(X).indexOf(o.icon) ? (i = k(".".concat(J.icon, ".").concat(X[o.icon])), rt(i), Kt(i, o), zt(i, o), vt(i, o.showClass.icon)) : Y('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))), function (t) {
            var e = E();
        ...
        }(e), a = e, s = A(), ct(s, a.title || a.titleText), a.title && mt(a.title, s), a.titleText && (s.innerText = a.titleText), z(s, a, "title"), c = e, u = R(), _(u, c.closeButtonHtml), z(u, c, "closeButton"), ct(u, c.showCloseButton), u.setAttribute("aria-label", c.closeButtonAriaLabel)
    }

    function Ut(t, e) {
        var n, o, i, r;
        n = e, o = x(), it(o, "width", n.width), it(o, "padding", n.padding), n.background && (o.style.background = n.background), $t(o, n), Et(0, e), Nt(t, e), Vt(t, e), ht(0, e), i = e, r = M(), ct(r, i.footer), i.footer && mt(i.footer, r), z(r, i, "footer"), "function" == typeof e.didRender ? e.didRender(x()) : "function" == typeof e.onRender && e.onRender(x())
    }
    ...
    function oe(t) {
        for (var e in t) ee(i = e) || K('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== ce.indexOf(o) && K('The parameter "'.concat(o, '" is incompatible with toasts'))), ne(n = e) && g(n, ne(n));
        var n, o, i
    }
    ...
    function le() {
        var t, e = Tt.innerParams.get(this);
        e && (t = Tt.domCache.get(this), at(t.loader), e.showConfirmButton ? rt(t.confirmButton) : e.showConfirmButton || e.showCancelButton || at(t.actions), yt([t.popup, t.actions], J.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.denyButton.disabled = !1, t.cancelButton.disabled = !1)
    }
    ...
    var me = function () {
        ...
        var e = t.target, n = C();
        return (!t.touches || !t.touches.length || "stylus" !== t.touches[0].touchType) && (e === n || !(ut(n) || "INPUT" === e.tagName || ut(P()) && P().contains(e)))
    }, ve = {swalPromiseResolve: new WeakMap};

    function ye(t, e, n, o) {
        var i;
        n ? ke(t, o) : (Xt().then(function () {
            return ke(t, o)
        }), ie.keydownTarget.removeEventListener("keydown", ie.keydownHandler, {capture: ie.keydownListenerCapture}), ie.keydownHandlerAdded = !1), e.parentNode && !document.body.getAttribute("data-swal2-queue-step") && e.parentNode.removeChild(e), N() && (null !== tt.previousBodyPadding && (document.body.style.paddingRight = "".concat(tt.previousBodyPadding, "px"), tt.previousBodyPadding = null), F(document.body, J.iosfix) && (i = parseInt(document.body.style.top, 10), yt(document.body, J.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * i), "undefined" != typeof window && pe() && window.removeEventListener("resize", fe), h(document.body.children).forEach(function (t) {
    ...
    function be(t) {
        ...
        }(t), (e = Tt.innerParams.get(this)) && !F(i, e.hideClass.popup) && (n = ve.swalPromiseResolve.get(this), yt(i, e.showClass.popup), vt(i, e.hideClass.popup), o = C(), yt(o, e.showClass.backdrop), vt(o, e.hideClass.backdrop), function (t, e, n) {
            var o = C(), i = At && lt(e), r = n.onClose, a = n.onAfterClose, s = n.willClose, c = n.didClose;
            if (we(e, s, r), i) {
                Ce(t, e, o, c || a)
            } else {
                ye(t, o, G(), c || a)
    ...
    var we = function (t, e, n) {
        ...
        ie.swalCloseEventFinishedCallback = ye.bind(null, t, n, G(), o), e.addEventListener(At, function (t) {
    ...
    function Se(t) {
        ...
        Ue(e, n, t), setTimeout(function () {
            He(e, n)
        }, 10), N() && (Ne(e, t.scrollbarPadding, o), h(document.body.children).forEach(function (t) {
            t === C() || function (t, e) {
        ...
        })), G() || ie.previousActiveElement || (ie.previousActiveElement = document.activeElement), Re(n, t), yt(e, J["no-transition"])
    }

    function Oe(t) {
        var e, n = x();
        t.target === n && (e = C(), n.removeEventListener(At, Oe), e.style.overflowY = "auto")
    }

    function Te(t, e) {
        "select" === e.input || "radio" === e.input ? We(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && (v(e.inputValue) || b(e.inputValue)) && Ke(t, e)
    }
    ...
    var Re = function (t, e) {
            ...
            At && lt(e) ? (t.style.overflowY = "hidden", e.addEventListener(At, Oe)) : t.style.overflowY = "auto"
        }, Ne = function (t, e, n) {
            var o;
            ...
            var i = P();
            v(n.inputOptions) || b(n.inputOptions) ? (Jt(), y(n.inputOptions).then(function (t) {
                e.hideLoading(), o(t)
            ...
            })) : e.getInput().checkValidity() ? Je(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
        }, $e = function (t) {
            ...
            t.showLoaderOnConfirm && Jt(), t.preConfirm ? (e.resetValidationMessage(), Promise.resolve().then(function () {
                ...
                wt(O()) || !1 === t ? e.hideLoading() : je(e, void 0 === t ? n : t)
            })) : je(e, n)
        }, Xe = ["ArrowRight", "ArrowDown", "Right", "Down"], Ge = ["ArrowLeft", "ArrowUp", "Left", "Up"],
        tn = ["Escape", "Esc"], en = function (t, e, n) {
            ...
            t.shiftKey ? Me(0, o, -1) : Me(0, o, 1), t.stopPropagation(), t.preventDefault()
        }, rn = function (t) {
            var e, n;
            -1 !== [T(), L(), q()].indexOf(document.activeElement) && (e = -1 !== Xe.indexOf(t) ? "nextElementSibling" : "previousElementSibling", (n = document.activeElement[e]) && n.focus())
        }, an = function (t, e, n) {
            ...
            o.container.onclick = function (t) {
                ...
                cn ? cn = !1 : t.target === o.container && Q(e.allowOutsideClick) && i($.backdrop)
            }
        };
    var pn = function (t, e, n) {
        var o = V();
        at(o), e.timer && (t.timeout = new Ae(function () {
            n("timer"), delete t.timeout
        }, e.timer), e.timerProgressBar && (rt(o), setTimeout(function () {
            t.timeout.running && dt(e.timer)
        })))
    }, fn = function (t, e) {
        if (!e.toast) return Q(e.allowEnterKey) ? void (mn(t, e) || Me(0, -1, 1)) : hn()
    }, mn = function (t, e) {
    ...
    var gn, vn = function (t) {
        ...
        hideLoading: le, disableLoading: le, getInput: function (t) {
            var e = Tt.innerParams.get(t || this), n = Tt.domCache.get(t || this);
            ...
            _(e.validationMessage, t), e.validationMessage.className = J["validation-message"], n.customClass && n.customClass.validationMessage && vt(e.validationMessage, n.customClass.validationMessage), rt(e.validationMessage);
            var o = this.getInput();
            ...
            var e = function (t) {
                var e = c({}, re.showClass, t.showClass), n = c({}, re.hideClass, t.hideClass), o = c({}, re, t);
            ...
            Ee(e), Object.freeze(e), ie.timeout && (ie.timeout.stop(), delete ie.timeout), clearTimeout(ie.restoreFocusTimeout);
            var n = function (t) {
                var e = {
                    popup: x(),
                    container: C(),
            ...
            return Ut(this, e), Tt.innerParams.set(this, e), function (n, o, i) {
                return new Promise(function (t) {
                    var e = function t(e) {
            ...
            Object.keys(e).forEach(function (t) {
                wn.isUpdatableParameter(t) ? o[t] = e[t] : K('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
            });
            var i = c({}, n, o);
            Ut(this, i), Tt.innerParams.set(this, i), Object.defineProperties(this, {
                params: {
            ...
            e && (t.popup && ie.swalCloseEventFinishedCallback && (ie.swalCloseEventFinishedCallback(), delete ie.swalCloseEventFinishedCallback), ie.deferDisposalTimer && (clearTimeout(ie.deferDisposalTimer), delete ie.deferDisposalTimer), function (t) {
                if (typeof t.didDestroy === "function") {
                    t.didDestroy()
                } else if (typeof t.onDestroy === "function") {
                    t.onDestroy()
                }
            }(e), delete this.params, delete ie.keydownHandler, delete ie.keydownTarget, vn(Tt), vn(ve))
        }
    }), bn = function () {
        function r() {
            if (a(this, r), "undefined" != typeof window) {
                "undefined" == typeof Promise && Y("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), gn = this;
                for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    c(bn.prototype, yn), c(bn, ue), Object.keys(yn).forEach(function (t) {
        bn[t] = function () {
            if (gn) return gn[t].apply(gn, arguments)
        }
    }), bn.DismissReason = $, bn.version = "10.5.1";
    var wn = bn;
